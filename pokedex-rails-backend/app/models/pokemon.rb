...
class Pokemon < ApplicationRecord
    ...
    validates :number, :attack, numericality: { only_integer: true, greater_than: 0 }
    validates :defense, numericality: { only_integer: true, greater_than: 0, less_than_or_equal_to: 100 }
